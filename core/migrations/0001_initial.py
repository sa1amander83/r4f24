    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner_family', models.ManyToManyField(blank=True, related_name='runners_family', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kwteam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.teams', verbose_name='команда')),
            ],
            options={
