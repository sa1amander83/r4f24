    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner_status', models.IntegerField(choices=[(1, 'Участник'), (2, 'член семьи участника')], default=1, verbose_name='Ваш статус')),
                ('runner_team', models.PositiveIntegerField(db_index=True, verbose_name='команда')),
                ('runner_age', models.PositiveIntegerField(db_index=True, validators=[django.core.validators.MaxValueValidator(99), django.core.validators.MinValueValidator(5)], verbose_name='возраст')),
                ('runner_category', models.PositiveIntegerField(choices=[(1, 'Новичок'), (2, 'Любитель'), (3, 'Профи')], db_index=True, default=1, verbose_name='Заявляетесь в группу')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='Участник')),
                ('runner_family', models.ManyToManyField(blank=True, related_name='runners_family', to=settings.AUTH_USER_MODEL, verbose_name='Семья')),
            ],
            options={
