...
app_name='groups'
from .views import MyGroup, addRunnerToGroup, GroupsListView, add_group, view_group
...
urlpatterns = [
    ...
    path('profile/<slug:username>/addgroup/<slug:group>/', addRunnerToGroup, name='add_runner_to_group'),
