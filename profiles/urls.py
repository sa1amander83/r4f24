...
app_name='profile'
from .views import ProfileUser, InputRunnerDayData, EditRunnerDayData, DeleteRunnerDayData,  EditProfile, zaglushka
...
urlpatterns = [
    ...
    path('profile/<slug:username>/addrunday/', zaglushka, name='addrunday'),
